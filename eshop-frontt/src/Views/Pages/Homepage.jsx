...
import bgImg from "../../assets/images/pppp.jpg";
      ...
      <div style={{ fontFamily: "Poppins, sans-serif" }}>
        ...
        >
          ...
          <div className="hero-content">
            ...
            <a href="/shop" className="hero-btn">
              <FaShoppingBag style={{ color: "pink", marginRight: "8px" }} />
              Shop Now
            </a>
          </div>
        </section>
        ...
        >
          <div className="container">
            <h2
              ...
              style={{ color: "#ab6c93", fontFamily: "Poppins, sans-serif" }}
            >
              New Arrivals
            </h2>
            {errorMsg && (
        ...
        <section className="py-5" style={{ background: "#ffffff" }}>
          <div className="container d-flex flex-column">
            <div
              className="d-flex align-items-start flex-wrap mb-4"
              style={{ gap: "1.5rem" }}
            >
              <h2
              ...
              <div className="d-flex flex-wrap" style={{ gap: "1.5rem" }}>
                {[
                  ...
                  <div
                    key={idx}
                    className="bg-whisper p-5 rounded shadow-light text-center"
                    style={{ width: "200px" }}
                  >
          ...
          <div className="container">
            ...
            >
              ...
              <p className="mb-0" style={{ color: "#666", maxWidth: "400px" }}>
                Balance your beauty routine with expert care and premium
                ingredients.
              </p>
            </div>
            <div className="d-flex justify-content-center gap-5">
              {[
                ...
                <div key={idx} className="text-center">
                  ...
                  />
                  <p className="small mb-0" style={{ color: "#ab6c93" }}>
                    {label}
                  </p>
                </div>
              ))}
        ...
        <style jsx>{`
          ...
          .shadow-light {
            box-shadow: 0 6px 20px rgba(255, 102, 163, 0.2);
          }
          .bg-whisper {
